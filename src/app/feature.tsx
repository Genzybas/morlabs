...
const FEATURES = [
  {
    ...
    children:
      "Accelerate your development with ready-to-use SDK and pre-build modules for common Web3 functionalities.",
  },
  {
    icon: HeartIcon,
  ...
  return (
    <section className="py-28 px-4">
      <div className="container mx-auto mb-20 text-center">
        ...
        >
          Quick access to your most frequently used APIs and SDKs,
          Easily find APIs based on your project's needs,
          View all your Web3 projects, track progress, and access your integrations.
        </Typography>
      </div>
